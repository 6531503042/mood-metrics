      ...
      <div className={theme === 'dark' ? 'dark' : ''}>
        <div className={`min-h-screen ${theme === 'dark' ? 'bg-black' : 'bg-gray-50'} transition-colors duration-200`}>
          ...
          <div className="relative">
            ...
            <main className={`flex-grow p-8 ${theme === 'dark' ? 'bg-black' : 'bg-gray-50'}`}>
              <div className={`rounded-lg ${theme === 'dark' ? 'bg-gray-900' : 'bg-white'} shadow-lg p-6 transition-colors duration-200`}>
                {children}
              </div>
            </main>
          </div>
